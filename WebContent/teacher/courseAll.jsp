		...
		<table class="table panel-body" id="tableClass">
			...
			<tr>
				...
				<c:if test="${list.getStatus()  == 1}">
                    <td>&nbsp;<a href="EditCourseStatusServlet?courseID=${list.getCourseId() }&status=${list.getStatus()}">停办</a>&nbsp;</td>
                </c:if>
                <c:if test="${list.getStatus()  == 0}">
                    <td>&nbsp;<a href="EditCourseStatusServlet?courseID=${list.getCourseId() }&status=${list.getStatus()}">开设</a>&nbsp;</td>
                </c:if>
