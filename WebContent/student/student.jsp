	...
	<div class="div_body">
		<nav class="navbar">
			<ul class="nav navbar-nav " style="border-bottom:#517fa4 2px">
				<li class="li-sty">教务管理系统<i class="fa fa-magic" aria-hidden="true"></i></li>
			...
			<ul class="nav">
				<li>
					...
					<ul id="menu-info" class="collapse">
						...
						<li><a href="ServletPwd" target="mainRight">修改登陆密码</a></li>
					</ul>
				</li>
				<li>
					...
					<ul id="menu-grades" class="collapse">
						...
						<li><a href="CourseSelectedShowServlet" target="mainRight">上课信息查看</a></li>
						<li><a href="ExamInfoShowServlet" target="mainRight">考试信息查看</a></li>
						<li><a href="CourseCanChooseServlet" target="mainRight">选择选修课</a></li>
					</ul>
				</li>
			</ul>
		</div>
